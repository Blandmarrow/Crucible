...
sync_env(None)
from backend.routers import booru, captions, captioning, comfy, datasets, detection, export, filesystem, images, inpaint, jobs, labels, lut, models, providers, quality, settings as settings_router, system, tag_consolidation, upscaling, versioning, videos
...
app.include_router(inpaint.router, prefix=PREFIX)
