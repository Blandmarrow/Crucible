...
| `docs/dev/gallery.md` | Working on `GalleryPage` or gallery drag & drop — selection and shift-click ranges, select-all-matching-filters, subfolder sidebar, filters, pagination, manual ordering, dnd-kit droppables and collision detection | ~4350 |
...
| `docs/dev/styling.md` | Working on Tailwind/CSS, the brand mark, or any modal dialog — CSS variable tokens, `@layer components` classes, `CrucibleMark` drift checks, `ConfirmDialog`, `useModalBehavior` | ~1700 |
