...
| `docs/dev/image-detail.md` | Working on `ImageDetailPage`, the style-match block or generation-metadata display — gallery/nav persisted keys, `injectNavId`/`paneGo`, crop tool, selection toggle, caption panel, `StyleMatchPanel` and `DinoLayerBreakdown` | ~2610 |
