...
| `docs/dev/image-files.md` | Working on image upload/move/copy/rename or caption import — naming and collisions, cross-dataset move and copy, folder import, rescan/sync, drag-`.txt`-onto-image | ~2010 |
...
| `docs/dev/workspace.md` | Working on hardware meters, `FileBrowserPage`, `LogsPage`, or `BooruPage` — the sidebar meters and `/system`, the file browser and `/filesystem`, job history + JS error console | ~3180 |
