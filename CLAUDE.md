...
| `docs/dev/bulk-image-jobs.md` | Working on `CropToDetectionForm`, batch resize/crop, or the thumbnail rebuild — the bulk jobs that rewrite files: `detection_crop_rect`, the crop remap, `batch_inpaint` and the LaMa paint mask, `thumbnails_stale`, PM-013 loop ordering | ~3445 |
