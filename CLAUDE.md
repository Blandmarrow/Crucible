...
| `docs/dev/gallery.md` | Working on `GalleryPage` or gallery drag & drop — selection and shift-click ranges, select-all-matching-filters, subfolder sidebar, filters, pagination, manual ordering, dnd-kit droppables and collision detection | ~3990 |
