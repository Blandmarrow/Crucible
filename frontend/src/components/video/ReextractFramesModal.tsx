 ...
 *
 * Backdrop-click closing stays off (the hook's default): the form holds an
 * in-flight job's ids once submitted, and a stray click on the overlay would drop
 * the progress readout. Escape still closes — that is an explicit gesture.
 */
