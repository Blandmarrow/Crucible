...
- Selection checkbox size (px slider, 14–32, live `GalleryCheckbox` preview). Stored under `GALLERY_CHECKBOX_SIZE_KEY` but owned by `uiPrefsStore`, not read directly — see `docs/dev/frontend-core.md` § Frontend constants.
