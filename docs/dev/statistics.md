...
`docs/dev/style-similarity.md`) caches here too. With three payload kinds per scope rather
...
See `docs/dev/style-similarity.md` for the style-similarity scoring flow and embedding types that populate `style_similarity_distribution`.
