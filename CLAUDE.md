...
| `docs/dev/video-extract.md` | Working on frame extraction, shot detection, or the extract/probe endpoints — Pass 1 triage: probe sampling and its RSS rule, the PySceneDetect contract and cost cliff | ~3775 |
