...
| `docs/dev/versioning.md` | Working on `VersionsPage`, `dataset_busy`, or any path that overwrites image files in place — snapshots, branches, the copy-on-write object store, diff, restore, prune/GC | ~3365 |
