...
| `docs/dev/image-detail.md` | Working on `ImageDetailPage`, the style-match block or generation-metadata display — gallery/nav persisted keys, `injectNavId`/`paneGo`, the post-delete nav refresh, crop tool, selection toggle, caption panel, `StyleMatchPanel` and `DinoLayerBreakdown` | ~4635 |
